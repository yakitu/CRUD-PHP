...
<body>
  ...
  if ($_SESSION['admin'] == 1) { //Si l'usuari vigent és administrador
    if (!isset($_POST["bot_actualitzar"])) {
      ...
      $adr = $_POST["adr"];
      $ccpp = $_POST["ccpp"];
      $sql = "update Advocats set dni=:midni, nom=:minom, cognom1=:micog1, cognom2=:micog2, telèfon=:mitel, email=:miema,
  ...
  <?php
    ...
    echo "<h4>Aquest usuari no està autoritzat per editar advocats</h4>";
  }
  ?>
</body>
